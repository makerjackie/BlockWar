      ...
      <main className='app-container'>
        <div className='center-layout justify-center'>
          <section className='w-full max-w-5xl'>
            ...
            <div className='menu-container relative flex max-h-[46vh] min-h-[16rem] flex-col overflow-auto p-0'>
            ...
            <div className='mt-4 flex flex-col gap-3'>
              ...
              <details className='menu-container overflow-hidden p-0'>
                ...
                <div
                  className='grid gap-3 border-t px-4 pb-4 pt-3 md:grid-cols-1'
                  style={{ borderColor: 'var(--bw-line)' }}
                >
                  <button
                    type='button'
